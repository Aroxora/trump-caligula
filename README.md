...
- **The Folly Index** — the centrepiece. A live formula
  ...
  - **21 catalogued failures** (Gulf war, Greenland, tariffs, a loyalist cabinet, DOJ retribution,
    the IG purge, National Guard deployments, CECOT removals, vaccine rollback, science cuts,
    climate, press suppression, the "Trump-class" battleship, the Anthropic DoD dispute, the
    gilded Oval, the parade…) plus the global backdrop (Ukraine, Gaza, Iran).
...
- **Caligula, seriously** — eleven deeply-sourced themes (early reign, the AD 37 illness, the fiscal
  crisis, Nemi ships, self-deification, the Senate humiliations, the seashells, the assassination,
