...
PRIMARY STRATEGY — A TYPHOON OF SILICON (硅台风): @trenchwork/vigil v2.0.30 — deployed AI-powered offensive cyber terminal agent (DeepSeek V4 Pro, 1M context, 8 tools). CVE Discovery Engine (1,264 lines verified). Exploit Chaining Engine (536 lines verified, A*/beam search, 7 verified chains, $75K bounties). Typhoon telecom audit framework (9 surfaces confirmed, carriers.py with AT&T/T-Mobile/Verizon/China Mobile). Deployed at trenchwork.live, erosolar.net, defense-osint.org. Built by Bo Shang / Trenchwork. All claims verified against repo as of June 2026. Read the full Typhoon concept below (Section: Primary Strategy).`;
...
// ---------------------------------------------------------------------------
// CLANDESTINE STRATEGIES — Exploiting Specific Alienation Vectors
// ---------------------------------------------------------------------------

export const PRC_CLANDESTINE = `The public section of this site documents nine categories of self-inflicted U.S. wounds that are visible to any reader of Western media. This annex describes clandestine strategies to exploit each — operations that should not appear in any public Chinese diplomatic communication, media statement, or institutional announcement.

CLANDESTINE 1: NATO Fracture Acceleration
The U.S. has called NATO obsolete, threatened withdrawal, demanded 5% GDP defense spending, and signaled Article 5 may not be honored. European allies are conducting contingency planning. China's clandestine posture: (a) approach European defense ministries through commercial intermediaries — offer joint defense-industrial cooperation that does not require alliance realignment, just diversification of supply chains, (b) identify specific NATO members whose domestic politics make alliance skepticism electorally viable — Hungary, Slovakia, potentially Italy or France under certain leadership — and ensure those political forces have access to funding, media platforms, and policy research that supports skepticism, all through attribution-free channels, (c) cultivate retired European flag officers as consultants and advisors to Chinese defense-industry entities — their public statements questioning NATO reliability carry weight that Chinese statements cannot, (d) ensure that every U.S. statement attacking NATO is surfaced through European media channels without Chinese attribution — the content is Western-self-generated, the distribution is ensured. Principle: NATO dies by its own hand. China's role is to ensure the suicide note is widely read.

CLANDESTINE 2: Five Eyes Intelligence Degradation
The U.S. has shared classified information with unauthorized parties, purged intelligence leadership, and publicly attacked its own agencies as the "deep state." Five Eyes partners are restricting intelligence sharing with Washington. China's clandestine posture: (a) approach mid-level intelligence officers from Five Eyes partner agencies who are frustrated with Washington's information-security practices — not for recruitment, but for assessment of what intelligence is no longer being shared with the U.S., (b) identify specific intelligence-sharing restrictions that Five Eyes partners have imposed and map the resulting U.S. intelligence gaps — these are domains where the U.S. is blind and Chinese operations face reduced detection risk, (c) increase operational tempo in collection domains where U.S. intelligence gaps have been confirmed — SIGINT, HUMINT, and cyber operations in regions where Five Eyes coverage has degraded, (d) do not exploit the intelligence-sharing breakdown publicly — any Chinese statement about Five Eyes fractures triggers the reconsolidation response. Principle: operate in the gaps. The gaps speak for themselves.

CLANDESTINE 3: Canada Realignment Cultivation
The U.S. has threatened Canada with economic punishment, called its Prime Minister "Governor," and imposed tariffs on its core industries. Canada is actively diversifying trade away from the United States. China's clandestine posture: (a) deepen bilateral trade and investment relationships with Canada on standard commercial terms — no political conditions, no alliance-framing, no security-cooperation offers, (b) approach Canadian provincial governments directly — provinces control natural resources, energy policy, and significant trade authority — for economic cooperation agreements that do not require federal-level foreign-policy alignment, (c) offer Canadian energy exporters long-term purchase agreements that provide price stability the U.S. market no longer guarantees, (d) ensure that every U.S. insult toward Canada is surfaced in Canadian media without Chinese attribution — the content drives the wedge, China provides the commercial alternative. Principle: Canada is not an ally to be poached. Canada is a neighbor that has been mistreated and needs a reliable economic partner. China provides the partnership. Canada makes its own decisions.

CLANDESTINE 4: Greenland/Danish Sovereignty Reinforcement
The U.S. has threatened to annex Greenland — territory of NATO ally Denmark — by economic coercion or military force. China's clandestine posture: (a) offer Greenland increased investment in rare-earth mining, port infrastructure, and telecommunications on standard commercial terms — the projects are commercially viable regardless of geopolitics, (b) approach Danish defense and foreign ministries through commercial intermediaries — offer to jointly fund Arctic scientific research, climate monitoring, and search-and-rescue infrastructure that demonstrates Chinese commitment to Arctic stability, (c) ensure that the U.S. annexation threat is documented and circulated in every Arctic Council, Nordic Council, and UN General Assembly forum — not by China, but by the states and NGOs that are already alarmed by it, (d) do not make a single public Chinese statement about Greenland. The U.S. threat speaks for itself. China's commercial presence in Greenland speaks for itself. The two should never be connected in any public Chinese communication. Principle: be the country that is not threatening to take territory from an ally. The contrast requires no amplification.

CLANDESTINE 5: Military Leadership Cultivation
The U.S. has purged the Chairman of the Joint Chiefs, service chiefs, and JAGs for political loyalty. Retired and sidelined officers represent a pool of expertise that is no longer serving the U.S. government. China's clandestine posture: (a) approach retired U.S. flag officers through academic, consulting, and business channels — offer genuine advisory roles with Chinese defense-industry entities, think-tank fellowships, and speaking engagements, (b) these officers provide assessment of U.S. capability degradation from the inside — they know what was lost, what procurement is failing, what readiness gaps exist, (c) do not seek classified information — seek professional assessment of observable capability trends, which retired officers can provide without compromising their legal obligations, (d) do not frame these relationships as intelligence collection — frame them as professional consulting, which they genuinely are. Principle: the officer corps knows the U.S. military is being hollowed out. They will tell anyone who asks — including Chinese entities that ask professionally and compensate appropriately. This is not espionage. This is consulting.

CLANDESTINE 6: Dollar-Alternative Acceleration Through Non-Chinese Channels
U.S. weaponization of the dollar system through sanctions is accelerating global de-dollarisation. China's clandestine posture: (a) fund and support research, policy papers, and financial-industry analysis by non-Chinese economists and institutions that document the risks of dollar dependence — the research is genuinely independent, the funding is attribution-free, (b) approach sovereign wealth funds, central bank reserve managers, and finance ministries in states seeking dollar alternatives — offer technical assistance on RMB-denominated reserve management, CIPS integration, and bilateral swap-line negotiation, (c) ensure that BRICS, SCO, and ASEAN+3 discussions of de-dollarisation are led by non-Chinese members — China supports the agenda but does not drive it publicly, (d) provide the financial plumbing (CIPS, swap lines, AIIB lending) without demanding public acknowledgment. The plumbing works regardless of who gets credit. Principle: the dollar system is being abandoned by its own users. China provides the lifeboats. The users row themselves.`;

// ---------------------------------------------------------------------------
// IMMEDIATE GAIN OPERATIONS — This Quarter
// ---------------------------------------------------------------------------

export const PRC_IMMEDIATE_GAIN = `The following operations can produce measurable Chinese strategic gain within the current quarter (Q3 2026). They are calibrated for immediate execution against an administration that is distracted, impulsive, and self-harming. Each operation includes: the specific action, the expected gain, the window of opportunity, the execution requirements, and the abort condition.

GAIN 1: Canada Trade Diversification — Emergency Commercial Offer
Action: Within 30 days, approach the Canadian government through commercial and diplomatic channels with a comprehensive trade package: (a) immediate tariff-free access to the Chinese market for Canadian softwood lumber, canola, pork, beef, and aluminum — all products currently facing U.S. tariffs, (b) a 5-year RMB-denominated commodity-purchase agreement for Canadian oil and gas at prices indexed to a basket of currencies rather than USD alone, (c) expedited regulatory approval for Canadian agricultural exports that currently face Chinese phytosanitary restrictions — lift restrictions that were imposed during previous diplomatic tensions as a gesture of renewed commercial partnership. Expected gain: Canada announces a major trade diversification agreement with China within 90 days. The announcement occurs while the U.S. is still imposing tariffs on Canadian goods. The contrast is visible and politically potent in Ottawa. Window: Canada's trade diversification push is active now. The longer China waits, the more likely Canada finds alternative partners (EU, Japan, India). Execution: MOFCOM leads with MFA support. No political conditions attached. No security-cooperation language. Pure commercial offer. Abort if: Canada conditions the agreement on political concessions (human rights language, Taiwan statements) that exceed standard commercial diplomacy.

GAIN 2: EU Comprehensive Trade Framework — Counter-Tariff Positioning
Action: While the EU is under U.S. tariff pressure, approach the European Commission with a proposed EU-China Comprehensive Investment Framework that addresses the concerns that blocked the previous CAI: (a) include enforceable labor and environmental standards that meet EU requirements, (b) offer reciprocal market access provisions that give European firms genuinely improved access to Chinese markets, (c) propose a joint EU-China green-technology investment fund that positions China as a partner in European decarbonization rather than a competitor. Expected gain: EU announces resumption of investment-framework negotiations within 60 days. Even if a final agreement takes years, the announcement of resumed negotiations signals to Washington that Europe has alternatives. Window: EU trade policy is being recalibrated in response to U.S. tariffs. The window for a Chinese offer is now — before the EU concludes that its best response is a united transatlantic front. Execution: MOFCOM leads. MFA supports. The offer must be genuine — market-access provisions must be real, not cosmetic. The EU will test them. Abort if: EU demands security-cooperation conditions or Taiwan-related provisions that exceed commercial-diplomacy scope.

GAIN 3: WHO Leadership Announcement — Same Week as U.S. Withdrawal
Action: The day after the U.S. formally withdraws from the WHO, announce: (a) a 30% increase in Chinese assessed and voluntary contributions to the WHO over the next three years, (b) the establishment of a Chinese-funded global pandemic-preparedness center in Geneva, (c) secondment of Chinese public-health experts to WHO regional offices in Africa, Southeast Asia, and the Western Pacific, (d) an emergency health-diplomacy fund for developing states facing disease outbreaks — no political conditions, rapid disbursement. Expected gain: China is positioned as the global health leader within 48 hours of the U.S. withdrawal. The announcement leads every global-health publication and every Global South foreign ministry briefing. The U.S. departure and Chinese arrival are a single news cycle. Window: The U.S. withdrawal is a fixed event. The announcement must be timed to the day after — not the same day (which looks opportunistic) and not a week later (which looks indecisive). Execution: NHC and MFA coordinate. Announcement drafted and held ready. Released within 24 hours of U.S. withdrawal notification to the UN. Abort if: The U.S. withdrawal is delayed, contested in U.S. courts, or reversed before taking effect.

GAIN 4: Rare-Earth Processing Capacity Announcement — Defense-Industrial Signal
Action: Announce that China will increase rare-earth processing capacity by 25% over the next three years and will offer long-term supply contracts to allied and partner states at stable prices with no political conditions. Simultaneously, signal through commercial channels that U.S. defense contractors who have diversified their rare-earth supply chains away from China will not face export restrictions as long as the processed materials are used for commercial rather than weapons applications — and that China reserves the right to restrict exports for weapons applications. Expected gain: U.S. defense contractors face an immediate choice: maintain China-dependent supply chains at risk of restriction, or invest billions in alternative processing capacity that takes 5+ years to build. The announcement creates uncertainty that delays U.S. procurement decisions — every month of delay is a month the PLA's capability gap widens. Window: U.S. rare-earth processing investment is in early stages. The announcement must come before U.S. contractors commit to alternative supply chains. Once committed, the leverage is lost. Execution: Ministry of Industry and Information Technology leads. MOFCOM coordinates on export-control language. Abort if: The announcement triggers immediate U.S. Defense Production Act invocation for rare-earth processing — this accelerates U.S. investment rather than delaying it.

GAIN 5: BRICS+ Emergency Liquidity Facility — Financial Architecture Play
Action: Propose and secure BRICS+ agreement on an emergency liquidity facility that provides short-term balance-of-payments support to member states in RMB rather than USD. The facility is structured as a complement to the IMF, not a replacement — but it offers terms that are faster, less conditional, and in a currency that is not subject to U.S. sanctions risk. Initial capitalization: $100 billion RMB-equivalent. Expected gain: Within 90 days, at least 3-5 BRICS+ member states announce intention to draw on the facility for trade-settlement support. Each draw reduces those states' dependence on dollar-denominated trade finance. The facility also pressures the IMF to reform its own lending conditions — China benefits from either outcome. Window: BRICS summit calendar (Q3 2026). The proposal must be agreed before the summit communique is drafted. Execution: PBOC and MOF lead. MFA coordinates with BRICS sherpas. Abort if: Key BRICS members (India, Brazil, Saudi Arabia) oppose the facility on grounds that it competes with IMF programs they value.

GAIN 6: Taiwan Business Incentive Package — Economic Integration Without Confrontation
Action: Announce a comprehensive package of business incentives for Taiwanese companies: (a) preferential access to mainland Chinese markets for Taiwanese semiconductor design firms, (b) joint-venture opportunities in mainland China's renewable-energy and EV supply chains, (c) streamlined residency and work permits for Taiwanese professionals in mainland China, (d) a cross-strait innovation fund that invests in Taiwanese startups with mainland market access. No political conditions. No unification language. Pure economic integration. Expected gain: Taiwanese business leaders — the most politically influential constituency on the island — gain material reason to oppose policies that disrupt cross-strait economic integration. The package creates a business constituency for stability that constrains political leadership on both sides. Window: Taiwan's domestic political cycle. The offer must be made before Taiwan's political leadership commits to policies that make acceptance politically impossible. Execution: Taiwan Affairs Office leads. MOFCOM supports. The package must be purely economic — any political framing destroys its effectiveness. Abort if: Taiwan's leadership publicly rejects the package and frames it as unification-through-economics. The package then becomes a political liability rather than an economic incentive.

GAIN 7: Friends of Multilateralism Summit — Diplomatic Theater That Works
Action: Convene a "Friends of Multilateralism" summit in Beijing, inviting every state that the U.S. has alienated through tariff threats, institutional withdrawal, or public insult. Agenda: (a) reaffirmation of multilateral institutions the U.S. is abandoning, (b) joint statement on the importance of predictable trade rules, (c) establishment of a working group on multilateral institutional reform — not to replace U.S.-led institutions, but to ensure they function when the U.S. is absent. The summit is not anti-American. It is pro-multilateralism. The U.S. is welcome to attend. Expected gain: A group photo of 50+ heads of state in Beijing affirming multilateralism while Washington imposes tariffs on all of them. The image is the message. The summit costs a few million dollars. The photo is worth billions in soft-power currency. Window: Before the UNGA High-Level Week (September 2026). The summit positions Beijing as the convener of the multilateral community before the UNGA positions New York as the same. Execution: MFA leads. Invitations extended within 14 days. Abort if: Key invitees decline, leaving the summit as a gathering of states with pre-existing Chinese alignment. The summit needs European, Latin American, and African attendance to be credible.

GAIN 8: Direct Sovereign Wealth Fund Approach — Reserve Diversification
Action: Through PBOC and SAFE, approach the sovereign wealth funds of Saudi Arabia, UAE, Kuwait, Qatar, Norway, and Singapore with a confidential proposal: China will facilitate RMB-denominated bond issuance with sovereign-guarantee-equivalent backing, offering yields competitive with U.S. Treasuries and without the sanction risk. The proposal is not public. It is a bilateral financial discussion. Expected gain: Within 6 months, 2-3 major sovereign wealth funds increase their RMB-denominated holdings by a measurable percentage. The shift is gradual, quiet, and self-reinforcing — once RMB holdings reach a threshold, other funds follow to avoid being the last ones holding concentrated USD exposure. Window: While U.S. Treasury auctions show stress and the dollar's safe-haven status is questioned. The window is now — if U.S. fiscal policy stabilizes, the urgency fades. Execution: PBOC and SAFE lead. Bilateral discussions only. No public announcement. Abort if: Any approached fund publicly discloses the proposal, triggering U.S. counter-pressure.

GAIN 9: Global South Debt Restructuring Leadership
Action: Propose a Beijing-based international debt-restructuring mechanism for developing states facing sovereign-debt distress. The mechanism offers: (a) faster restructuring timelines than the Paris Club, (b) RMB-denominated bridge financing during restructuring, (c) technical assistance on debt-management and fiscal policy, (d) no political conditions beyond standard anti-corruption provisions. Expected gain: Developing states facing debt distress — there are dozens — now have an alternative to IMF programs with their associated austerity conditions. China positions itself as the leader of a parallel financial architecture that offers better terms. Window: Sovereign-debt distress is rising globally. The first-mover advantage in restructuring architecture is real. Execution: MOF and PBOC lead. The mechanism must be genuinely better than the alternatives — if it is perceived as debt-trap diplomacy, it fails. Abort if: The mechanism is widely characterized in Global South media as "Chinese debt-trap 2.0."

GAIN 10: Technology Standards Leadership — 6G, AI Safety, Quantum
Action: Announce that China will host the inaugural International AI Safety Summit, the 6G Standards Coordination Conference, and the Quantum Computing Governance Forum — all within the next 12 months. Invite every state, every major technology company, and every standards body. The U.S. is welcome. The agenda is set by the host. Expected gain: China becomes the convening authority for the technology-governance architecture of the next decade. The standards set at these conferences will shape markets worth trillions. The host sets the agenda. The agenda shapes the standards. The standards determine whose technology is compliant and whose is not. Window: The U.S. is absent from global technology-governance discussions due to its withdrawal from multilateral bodies and its adversarial posture toward its own technology companies. The window for claiming the convening role is now — before the EU or another actor fills it. Execution: MIIT leads. MFA and MOST support. Conferences must be genuine — token events without substantive outcomes damage credibility. Abort if: Major technology companies decline to participate at a level that makes the conferences non-credible.

GAIN 11: Exploit the NVIDIA Export-Control Backfire
The U.S. restricted NVIDIA GPU exports to China. Chinese AI labs — DeepSeek, Qwen, Ernie, and dozens of others — were forced to optimize for constrained hardware rather than abundant hardware. The result: models that match or exceed U.S. frontier performance on a fraction of the compute budget. DeepSeek V4 Pro runs on domestically available hardware. Chinese AI inference is cheaper per token than U.S. equivalents. The export controls intended to slow China down instead forced China to get efficient. The U.S. handed China the optimization race and lost. Action: (a) publicly highlight — through attribution-free channels — that U.S. export controls accelerated Chinese AI efficiency rather than retarding it, framing the controls as a strategic error that U.S. policymakers should reconsider, (b) increase investment in domestic chip fabrication (SMIC, Hua Hong, YMTC) to close the remaining fabrication gap within 3-5 years — the controls have already made this investment politically non-optional, (c) offer AI inference-as-a-service to Global South states at prices that U.S. providers cannot match, building dependency on Chinese AI infrastructure while the U.S. restricts its own companies from exporting. Expected gain: Chinese AI achieves cost and efficiency parity with U.S. AI within 18 months. The export controls become a case study in strategic self-harm that constrains future U.S. technology-policy options. Execution: MOST and MIIT coordinate. The public framing must be through Western analysts and economists, not Chinese state media. Abort if: U.S. export controls are relaxed, restoring Chinese access to U.S. chips and removing the efficiency incentive.

GAIN 12: Position China as the Unrestricted AI Power
The U.S. has restricted access to Mythos and GPT-5.6 for Chinese users and developers. Simultaneously, U.S. AI companies face increasing domestic regulatory pressure, liability exposure, and political attacks from an administration that views them as adversaries. China's posture: (a) ensure that every major Chinese AI model (DeepSeek, Qwen, Ernie, Kimi) is available globally without geopolitical restrictions — any developer, in any country, can access Chinese frontier AI, (b) offer Chinese AI infrastructure (cloud inference, model hosting, fine-tuning services) to developers in states that the U.S. restricts or that fear future U.S. restrictions, (c) frame Chinese AI as "open, unrestricted, and globally available" against U.S. AI as "gated, restricted, and politically controlled." The contrast is true. The U.S. is restricting its own AI exports. China is not. Expected gain: Chinese AI becomes the default choice for developers and enterprises in states that fear U.S. technology-access restrictions — which is essentially every state. Window: While U.S. AI companies are fighting their own government over export controls and liability. The window is now — if U.S. policy reverses, the opportunity narrows. Execution: MOST and CAC coordinate. The posture must be genuine — Chinese AI must actually be globally accessible without restrictions, or the contrast collapses. Abort if: U.S. AI companies successfully lobby for export-control relaxation, removing the restriction differential.

GAIN 13: Iran — Do Not Overinvest, Do Not Underposition
Iran is run by lunatics. Religious governments are not reliable partners. The U.S. approach to Iran — maximum pressure, rhetorical escalation, periodic military signaling — will likely fail, as previous administrations' approaches have failed. But that does not make Iran a Chinese strategic asset. China's posture: (a) maintain normal diplomatic and commercial relations with Iran — oil purchases, Belt and Road participation, arms-sales restraint — without deepening the relationship beyond commercial necessity, (b) do not position China as Iran's strategic patron — Iran's conflicts with the U.S., Israel, and Gulf states are not China's conflicts and should not become China's conflicts through entanglement, (c) use Iran as a demonstration case for Chinese diplomatic methodology: consistent, non-escalatory engagement with difficult states, contrasted against U.S. maximum-pressure oscillation. The contrast is the asset. Iran itself is not. Expected gain: China demonstrates that it can maintain stable relations with a state the U.S. cannot — without being dragged into that state's conflicts. Execution: MFA leads. Commercial relations through normal channels. No security guarantees. No defense-cooperation agreements. Abort if: Iran attempts to draw China into a U.S.-Iran military confrontation through escalation that China cannot disclaim responsibility for.

PRINCIPLE: These are not long-term strategic plays. They are immediate-gain operations designed to produce measurable return within the current quarter. Each is calibrated for an adversary that is distracted, impulsive, and self-harming. If the adversary becomes competent, most of these operations become higher-risk. Execute while the variable holds.`;

// ---------------------------------------------------------------------------
// DOMAIN EXPANSION — Cyber, Space, Maritime, Energy, Biotech, Quantum, Crypto
// ---------------------------------------------------------------------------

export const PRC_DOMAIN_EXPANSION = `The Decision Matrices cover five primary domains. The Immediate Gain Operations cover specific this-quarter actions. This annex covers the remaining domains where Chinese advantage can be built through tactical, cyber, and asymmetric means. Each domain is addressed with: the U.S. vulnerability, the Chinese tactic, the expected gain, and the operational principle.

DOMAIN: Space and Satellite
U.S. vulnerability: U.S. space architecture depends on a small number of high-value, difficult-to-replace satellites (GPS constellation, missile-warning satellites, reconnaissance platforms). The U.S. is not investing in distributed, attritable space architecture at pace. Chinese tactic: (a) accelerate deployment of low-earth-orbit satellite constellations (broadband, remote sensing, SIGINT) that provide redundancy the U.S. lacks, (b) offer space-based services (navigation, Earth observation, communications) to Global South states at prices below U.S. commercial providers, (c) develop and demonstrate—without using—co-orbital ASAT capability that signals the vulnerability of U.S. space assets without crossing the threshold of actual attack, (d) position China as the leader in space-debris mitigation and orbital-traffic management—a genuine global public good that also establishes Chinese norm-setting authority in space governance. Expected gain: within 3-5 years, Global South states depend on Chinese space services for critical infrastructure. U.S. space dominance is not challenged militarily—it is bypassed commercially. Principle: space is contested by making U.S. assets vulnerable and Chinese assets indispensable. Do not shoot down satellites. Make them irrelevant.

DOMAIN: Undersea and Submarine Warfare
U.S. vulnerability: U.S. undersea dominance depends on a small fleet of aging attack submarines (Virginia-class, ~50 boats) operating at declining readiness rates. Chinese shipbuilding capacity is 232x U.S. capacity (ONI assessment). Chinese tactic: (a) continue submarine fleet expansion at programmatic pace—Type 093B and Type 095 SSNs, Type 041 SSKs with AIP—without advertising hull counts or deployment patterns, (b) deploy undersea sensor networks (SOSUS-equivalent) in the South China Sea and First Island Chain that reduce the stealth advantage of U.S. submarines, (c) develop and demonstrate unmanned underwater vehicles (UUVs) for persistent ISR and mine warfare that cost a fraction of a submarine and impose asymmetric costs on U.S. anti-submarine warfare, (d) map and survey the undersea geography of the Western Pacific more thoroughly than the U.S. Navy—terrain knowledge is a force multiplier in undersea warfare. Expected gain: U.S. submarine operations in the Western Pacific become progressively costlier and riskier. The undersea domain shifts from U.S. dominance to contested parity. Principle: undersea advantage is won by knowing the terrain better than the adversary. Survey. Map. Deploy sensors. The submarines do the rest.

DOMAIN: Energy Dominance
U.S. vulnerability: U.S. energy policy oscillates between fossil-fuel expansion and renewable transition with each administration, creating investment uncertainty. The current administration favors fossil fuels while alienating allies who need energy security. Chinese tactic: (a) position China as the world's largest investor in both renewable energy manufacturing (solar panels, wind turbines, batteries, electrolyzers) and the critical-mineral supply chains that feed them, (b) offer long-term energy-supply contracts to European and Asian allies facing U.S. tariff uncertainty—Chinese-manufactured solar panels and batteries at stable prices, delivered on schedule, (c) accelerate fusion-energy research (EAST tokamak, CFETR) and quantum-energy applications—positions China for the post-fossil-fuel era regardless of U.S. policy oscillation, (d) build the global grid-interconnection infrastructure (UHV transmission lines, subsea power cables) that makes Chinese energy exports physically indispensable to neighboring states. Expected gain: within 5-10 years, multiple Asian and European states depend on Chinese energy technology supply chains that cannot be replaced by U.S. alternatives. Energy independence from the U.S. is energy dependence on China. The dependency is commercial, not coercive. Principle: energy advantage is built by being the cheapest, most reliable supplier of what everyone needs. The market does the rest.

DOMAIN: Biotechnology and Pharmaceutical Supply Chains
U.S. vulnerability: U.S. depends on China for 70-80% of active pharmaceutical ingredient (API) imports for generic drugs (FDA data). Chinese tactic: (a) maintain and deepen API supply-chain dominance—not through restriction, but through cost and scale advantages that U.S. onshoring cannot match, (b) accelerate investment in biotech research (gene sequencing, synthetic biology, mRNA platforms, personalized medicine) to achieve parity with U.S. biotech within 5-10 years, (c) offer pharmaceutical cooperation agreements to developing states—Chinese-manufactured generics at prices below Western alternatives, with technology-transfer provisions that build long-term dependency, (d) position China as the global leader in pandemic preparedness and vaccine diplomacy—a natural extension of WHO leadership (Gain 3). Expected gain: within 3-5 years, Global South pharmaceutical supply chains are structurally dependent on Chinese API production and generic manufacturing. U.S. efforts to onshore pharmaceutical production face scale and cost challenges that make dependence persistent. Principle: pharmaceutical dominance is not exercised through restriction. It is maintained through being the cheapest, most reliable supplier. The dependency is structural, not coercive.

DOMAIN: Quantum Technology
U.S. vulnerability: U.S. quantum-computing investment is fragmented across multiple companies and agencies with no coordinating strategy. Quantum-communication investment is minimal compared to China. Chinese tactic: (a) accelerate quantum-key-distribution (QKD) satellite networks (Micius/QUESS follow-ons) that provide un-interceptable communication—position China as the provider of quantum-secure communications to states that fear U.S. SIGINT, (b) invest in quantum-computing applications for materials science, drug discovery, and financial modeling that produce civilian-economic returns while also advancing military-relevant capabilities, (c) propose international quantum-technology governance standards that favor Chinese technical approaches—as the first mover in QKD deployment, China sets the standard, (d) offer quantum-secure communication services to friendly states as a diplomatic and commercial offering. Expected gain: within 5-10 years, quantum-secure communications become a Chinese-provided global utility. States that want communications the U.S. cannot intercept buy Chinese quantum services. Principle: quantum advantage is not about breaking encryption. It is about providing communications that cannot be broken. The provider of un-interceptable communications is indispensable.

DOMAIN: Cryptocurrency and Blockchain Infrastructure
U.S. vulnerability: U.S. cryptocurrency policy oscillates between hostility (current administration's skepticism) and embrace (industry lobbying). Regulatory uncertainty drives crypto innovation offshore. Chinese tactic: (a) maintain the digital yuan (e-CNY) as the world's most advanced central-bank digital currency—expand cross-border e-CNY settlement agreements with Belt and Road states, (b) while maintaining domestic crypto restrictions, allow and facilitate Chinese blockchain-infrastructure companies to dominate global crypto mining (hardware manufacturing, mining-pool operation, ASIC design), (c) position Chinese blockchain platforms (BSN, AntChain, Tencent Blockchain) as the infrastructure layer for Global South digital-identity, supply-chain tracking, and financial-inclusion applications, (d) develop China's own decentralized-finance (DeFi) protocols that operate under Chinese regulatory frameworks—providing a regulated alternative to unregulated Western DeFi. Expected gain: within 3-5 years, Global South digital-payment and blockchain infrastructure runs on Chinese hardware and software. The digital yuan becomes the default CBDC for cross-border settlement among Belt and Road states. Principle: blockchain is infrastructure. Whoever builds the infrastructure sets the rules. China builds the infrastructure.

DOMAIN: Maritime Shipping and Port Infrastructure
U.S. vulnerability: U.S. maritime shipping depends on global chokepoints and port infrastructure that is increasingly Chinese-operated (COSCO, Piraeus, Gwadar, Hambantota, Djibouti). Chinese tactic: (a) continue acquiring operational stakes in container terminals at strategic chokepoints—not for military use, but for commercial leverage that can be exercised through "operational delays" indistinguishable from normal logistics friction, (b) offer port-infrastructure development packages to states seeking alternatives to Western-financed infrastructure—the package includes construction, operation, and maintenance, creating structural dependency, (c) build the world's largest merchant fleet (already the largest by tonnage) and offer shipping services at prices below market rates to friendly states, (d) develop Arctic shipping routes (Northern Sea Route) as climate change opens them—Chinese icebreaker construction and Arctic port investment positions China as the dominant Arctic shipping power. Expected gain: within 5-10 years, critical global shipping chokepoints have Chinese-operated terminals. Supply-chain disruption leverage is exercised commercially, not militarily. Principle: control the ports, control the trade. Control the trade, control the terms.

DOMAIN: Cyber-Physical Infrastructure Targeting
U.S. vulnerability: U.S. critical infrastructure (power grid, water systems, pipelines, transportation) is operated by thousands of private entities with inconsistent cybersecurity postures. Chinese tactic: (a) maintain persistent-but-dormant access to U.S. critical-infrastructure networks—not for immediate exploitation, but as a demonstrated capability that can be activated if the U.S. escalates cyber operations against Chinese infrastructure, (b) deploy AI-driven vulnerability scanners (Vigil CVE Discovery Engine) against U.S. industrial-control-system vendors to identify zero-days that are catalogued but not exploited, (c) ensure that U.S. defenders discover evidence of Chinese presence on critical-infrastructure networks—not enough to trigger a crisis, but enough to establish deterrence credibility, (d) never activate cyber-physical effects against U.S. infrastructure—the capability deters by existing, not by being used. Expected gain: U.S. policymakers know that Chinese cyber capability can impose costs on U.S. critical infrastructure if the U.S. escalates first. The capability is deterrent, not offensive. Principle: the best cyber weapon is the one the adversary knows exists but has never seen used. Deterrence is established by demonstrating presence, not by demonstrating effects.

DOMAIN: Academic and Research Influence
U.S. vulnerability: U.S. academic research depends on international collaboration and Chinese graduate students. The current administration's anti-China rhetoric and visa restrictions are reducing Chinese student enrollment in U.S. universities. Chinese tactic: (a) accelerate the development of Chinese universities (Tsinghua, Peking, Fudan, Zhejiang) to world-class research status—retain the talent that the U.S. is turning away, (b) offer research funding and laboratory access to international scientists who face funding cuts or political pressure in the U.S., (c) fund collaborative research programs with Global South universities that build long-term academic networks aligned with Chinese research priorities, (d) publish Chinese-language scientific journals with English abstracts that become mandatory citations in their fields—establish Chinese as a language of scientific publication. Expected gain: within 10-20 years, the center of gravity in multiple scientific fields shifts from U.S. institutions to Chinese institutions. The shift is organic—the U.S. is reducing its own attractiveness while China is increasing its own. Principle: science is global. The country that funds the best research attracts the best researchers. The country that attracts the best researchers produces the best science. The cycle accelerates.

DOMAIN: Legal and Standards Warfare
U.S. vulnerability: U.S. is withdrawing from international legal bodies (ICC, WTO Appellate Body) and standards-setting organizations—ceding influence over the rules that govern global commerce. Chinese tactic: (a) increase Chinese representation in international legal bodies (International Law Commission, UNIDROIT, UNCITRAL, ISO, ITU, IEEE)—every Chinese judge, arbitrator, and standards-committee chair is a vote, (b) propose alternative dispute-resolution mechanisms (Beijing International Arbitration Center, China International Commercial Court) that offer faster, cheaper resolutions than Western alternatives, (c) develop Chinese technical standards (5G/6G, AI safety, quantum communication, EV charging, grid interconnection) as international ISO/IEEE standards through sustained committee participation, (d) train and deploy Chinese international lawyers in numbers matching or exceeding U.S. and European cohorts—legal influence is exercised through people, not through documents. Expected gain: within 10-20 years, international commercial disputes are increasingly resolved under Chinese law in Chinese venues. Technical standards for emerging technologies are Chinese-led. Principle: the country that writes the rules wins the game. The country that controls the referees wins the disputes. Deploy lawyers, judges, and standards engineers the way the PLA deploys ships.

PRINCIPLE: These domain-expansion tactics share a common logic. They are not about winning a confrontation with the United States. They are about building structural positions that make confrontation unnecessary. Each domain adds a layer of Chinese advantage that the U.S. cannot easily reverse—because the advantage is built on cost, scale, reliability, and presence, not on aggression. The U.S. is currently reducing its presence in every domain listed above. China is increasing its presence in every domain listed above. The asymmetry compounds.

DOMAIN: Semiconductor Self-Sufficiency
U.S. vulnerability: U.S. export controls restrict Chinese access to advanced semiconductors while simultaneously fracturing the global semiconductor supply chain, alienating allies whose companies (ASML, TSMC, Samsung, SK Hynix) lose Chinese revenue. Chinese tactic: (a) accelerate domestic fabrication (SMIC 7nm/5nm, Hua Hong, YMTC NAND, CXMT DRAM) to achieve self-sufficiency in mature-node chips within 2-3 years and advanced-node chips within 5-7, (b) dominate the legacy-chip market (28nm and above)—these chips power cars, appliances, industrial equipment, and military systems—offering prices below TSMC and Samsung, (c) invest in next-generation semiconductor technologies (silicon photonics, carbon nanotubes, GaN, SiC) to leapfrog the silicon scaling paradigm where the U.S. currently leads, (d) offer chip-fabrication services to Global South states that want domestic semiconductor capability—Chinese equipment, Chinese processes, Chinese training. Expected gain: within 5 years, China is self-sufficient in chips for 80% of domestic needs. The remaining 20% (advanced AI-training chips) is addressed through efficiency (DeepSeek-style optimization) rather than fabrication. Principle: the U.S. export controls accelerated Chinese semiconductor independence. Every restriction is a market China will never give back to U.S. suppliers.

DOMAIN: Artificial Intelligence Ecosystem Dominance
U.S. vulnerability: U.S. AI leadership depends on a small number of companies (OpenAI, Anthropic, Google, Meta) whose models are proprietary, restricted, and increasingly regulated by a hostile administration. Chinese tactic: (a) maintain a diverse ecosystem of open-weight and proprietary Chinese AI models (DeepSeek, Qwen, Ernie, Kimi, Yi, ChatGLM) that compete on performance while being globally available without geopolitical restrictions, (b) deploy Chinese AI infrastructure (cloud inference, model hosting, fine-tuning) to Global South states at prices below U.S. providers, (c) develop Chinese AI applications in domains where the U.S. is absent—AI for public health, AI for agriculture, AI for education, AI for disaster response—that build dependency on Chinese AI platforms, (d) establish Chinese AI safety and ethics standards as international norms through sustained participation in global AI governance bodies. Expected gain: within 3-5 years, the default AI infrastructure for Global South states is Chinese. The default AI models for non-English languages are Chinese. The default AI governance framework is Chinese-led. Principle: AI dominance is not about having the best model. It is about being the provider everyone uses. Open access + low prices + no restrictions = market dominance.

DOMAIN: Cultural, Media, and Language Soft Power
U.S. vulnerability: U.S. cultural dominance (Hollywood, streaming platforms, social media, English language) is being eroded by platform fragmentation, content-localization demands, and anti-American sentiment in key regions. Chinese tactic: (a) expand CGTN, Xinhua, and Chinese streaming platforms into Global South markets—not as propaganda outlets, but as genuine content providers offering entertainment, news, and educational programming in local languages, (b) fund and distribute non-Chinese-produced content that aligns with Chinese strategic interests without carrying a Chinese brand—independent documentary filmmakers, Global South game developers, African and Latin American animation studios, (c) establish Confucius Institutes and Chinese-language programs that teach Mandarin as a professional skill rather than a cultural project—position Chinese as the language of business opportunity, not ideological alignment, (d) dominate the global mobile-gaming market (Tencent, NetEase, miHoYo) and use gaming platforms as vectors for Chinese cultural influence without political framing. Expected gain: within 10-20 years, Mandarin is a competitive professional skill globally. Chinese entertainment platforms are default options in Global South markets. Chinese cultural influence is exercised through content, not through rhetoric. Principle: soft power is not projected through propaganda. It is projected through content that audiences choose to consume. Make better content. Distribute it more broadly. Charge less for it. The audience does the rest.

SYSTEM INTEGRATION: How All Domains Work Together

The framework now covers 25+ domains. They do not operate independently. They form a system:

- Cyber (Vigil/Typhoon/Annex B) provides the intelligence and access layer—knowing what the adversary will do before they do it
- AI (DeepSeek/Typhoon Vectors) provides the analytical layer—processing intelligence faster than human analysts
- Diplomatic (DM-3, Clandestine, Public Strategy) provides the relationship layer—converting adversary dysfunction into partnership opportunities
- Economic (DM-4, Financial Warfare, Supply Chain) provides the leverage layer—building dependencies that survive U.S. policy reversal
- Military (DM-1, PLA Annex, Undersea, Space) provides the deterrence layer—making confrontation costlier for the adversary
- Institutional (DM-2, WHO, Standards) provides the governance layer—shaping the rules others must follow
- Information (DM-5, Influence Grid, Cultural) provides the perception layer—ensuring the adversary's self-inflicted wounds are visible
- Technical (Semiconductor, Quantum, Energy, Biotech) provides the infrastructure layer—building structural positions the adversary cannot reverse

The system's output is not any single action. It is a strategic environment in which Chinese advantage accumulates across every domain simultaneously, faster than the adversary can respond in any single domain. The adversary faces a choice: contest China in space (expensive), contest China in semiconductors (already lost the legacy market), contest China in AI (already restricting its own companies), contest China in energy (Chinese panels are cheaper), contest China in ports (Chinese terminals are already operating). Each choice costs resources the adversary does not have. Each choice not made cedes another domain. The system is designed so that there is no single point of U.S. resistance that reverses the trajectory. The trajectory is the accumulation of small advantages across every domain. The sum is strategic dominance. The parts are individually defensible, commercially justified, and diplomatically unobjectionable.`;
...
Vigil (@trenchwork/vigil v2.0.30) is a multi-modal terminal agent combining DeepSeek V4 Pro (1M context window, 8 tools) with a comprehensive offensive/defensive security toolkit. It ships as an npm package and Docker container with full Kali Linux + Ghidra headless integration. Architecture per the repo: ~200 TypeScript source files (210 confirmed), monolithic AWS Lambda API backend, React 19 SPA frontend with Stripe RMB integration, three-stage Docker image (Kali Linux rolling → Ghidra → Node.js + Vigil).

Fielded capabilities (verified against repo as of June 2026):
- CVE Discovery Engine (src/core/cveDiscovery.ts, 1,264 lines): Zero-day discovery from first principles — grammar-aware coverage fuzzer, static pattern analyzer, differential binary analyzer, LLM-powered novelty engine.
- Exploit Chaining Engine (src/core/exploitChaining.ts, 536 lines): Builds attack graphs using A*/beam search over composable exploit primitives and security state transitions. 7 verified chains per BOUNTY-REWARDS.md — $75,000 in documented bounty payouts, $690,000 potential across 15 programs (Apple, Microsoft, Google, Amazon, Meta, NVIDIA, Cloudflare, Intel, Linux Foundation, PayPal, GitHub, Docker, Kubernetes, Shopify, Uber).
- MCP Tool Servers: Kali Linux (70+ offensive tools per resume), Ghidra headless (5 Java scripts in tools/ghidra), network defense, endpoint defense, cloud security (AWS), API security, threat feed.
- Typhoon Tool (tools/typhoon): Autonomous telecom carrier security audit across 9 protocol surfaces — SS7, SIP/VoIP, Diameter, GRX/IPX, Lawful Intercept/CDR/Hadoop/Kafka, CIP/ENIP (industrial control), CAN bus (automotive), BGP hijack. Per carriers.py: AT&T Mobility, T-Mobile US, Verizon, China Mobile, and additional carrier profiles. Produces structured JSON audit artifacts with MITRE ATT&CK mappings.
- Guardrails: Three-tier authorization model (CNE/CNA per VIGIL-AI-CAPABILITIES.md), PRC law compliance module, safety refusal detection, scope enforcement, authorized target verification. Defensive boundary per VIGIL-AI-CAPABILITIES.md: CNE-only by design — no exploit payload generation, no C2 framework components, no unauthorized access.
