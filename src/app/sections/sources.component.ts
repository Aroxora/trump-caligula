...
@Component({
      ...
      <ul class="biblio">
        @for (s of sources; track s.key) {
          <li class="ref rel-{{ s.reliability }}">
            ...
            @if (s.url) {
              <a class="ref__url" [href]="s.url" target="_blank" rel="noopener noreferrer">{{
                s.url
              }}</a>
            }
          </li>
  ...
  styles: [
    `
      ...
      .rel-primary-hostile.k,
      .k.rel-primary-hostile {
      ...
      .rel-modern-scholarship {
        border-left-color: #2c4f86;
      }
      .k.rel-modern-scholarship {
        background: rgba(40, 70, 120, 0.14);
        color: var(--rel-scholarship);
      }
      .rel-journalism {
        border-left-color: #2f6b4c;
      }
      .k.rel-journalism {
